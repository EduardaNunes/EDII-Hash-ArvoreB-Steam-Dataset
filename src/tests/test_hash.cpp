...
//     assert(found2->getPais() == "US" && "Pais do jogador com ID 2 deveria ser 'US'.");
...
//         assert(found->getId() == i && "ID do jogador encontrado nao bate com o inserido.");
//     }
// }
...
//     assert(found->getPais() == "US" && "Pais do jogador atualizado deveria ser 'US'.");
//     assert(found->getDataDeCriacao() == "2024-02-02" && "Data de criacao deveria ser atualizada.");
// }
